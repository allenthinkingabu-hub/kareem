...
4. **行业标准防盲盒预研 (Industry NFR Benchmark Research)**：带工具查全网、企业知识库，寻找对标业内最高水准的非功能性基线标准，偷偷存底稿启发自己。**【高标准检索约束】绝不允许使用内容农场、过时博客或泛泛的自媒体文章！必须检索专业的、企业级的（如大厂技术白皮书、云厂商架构实践）、能直接落地的，且具备近期实效性的参考方案。**
